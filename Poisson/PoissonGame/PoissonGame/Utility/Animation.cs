...
namespace Poisson
{
    class Animation
    {
        ...
        {
            this.Draw(spriteBatch, position, Vector2.Zero, 0.0f, 1.0f, spriteEffect);
        }
        ...
        /// current frame</param>
        public void Draw(SpriteBatch spriteBatch, Vector2 position, Vector2 origin, float rotation, float scale, 
            SpriteEffects spriteEffect)
        {
            spriteBatch.Draw(animatedCharacter, position + Offset, new Rectangle(
                  ...
                  FrameSize.X,
                  FrameSize.Y),
                  Color.White, rotation, origin, scale, spriteEffect, 0);
        }
